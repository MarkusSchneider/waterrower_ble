...
echo "  • Check status:    sudo systemctl status waterrower"
echo "  • View logs:       sudo journalctl -u waterrower -f"
echo "  • Stop service:    sudo systemctl stop waterrower"
echo "  • Start service:   sudo systemctl start waterrower"
echo "  • Restart service: sudo systemctl restart waterrower"
echo "  • Disable autostart: sudo systemctl disable waterrower"
echo ""
